...
<body>
  ...
  <!-- ======= Hero Section ======= -->
  <section id="hero" style=" background: url({{asset('img/'.$home->bg_img)}}) no-repeat center " class="d-flex flex-column justify-content-center">
    <div class="container" data-aos="zoom-in" data-aos-delay="100">
      <h1>{{(@$home->name)?$home->name:"Name"}}</h1>
      <p>I'm <span class="typed" data-typed-items="{{(@$home->title)?$home->title:"Name"}}"></span></p><br>
      <a class="btn bg-info btn-xl text-uppercase js-scroll-trigger mt-6" href="{{asset('img/'.$home->resume)}}">Download Resume</a>
          ...
          @foreach ($project as $item)
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon-box iconbox-blue">
                <div class="icon">
                    <img width="200" height="100"  src="{{asset('img/'.$item->icon)}}" alt="">
